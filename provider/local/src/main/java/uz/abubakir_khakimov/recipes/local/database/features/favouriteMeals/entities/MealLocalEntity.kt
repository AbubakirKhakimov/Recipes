package uz.abubakir_khakimov.recipes.local.database.features.favouriteMeals.entities

import androidx.room.ColumnInfo
import androidx.room.Entity
import androidx.room.PrimaryKey

@Entity(tableName = "favourite_meals_table")
data class MealLocalEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "room_id") val roomId: Long,
