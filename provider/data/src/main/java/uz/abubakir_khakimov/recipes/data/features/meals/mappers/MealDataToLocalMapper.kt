...
internal class MealDataToLocalMapper: EntityMapper<MealDataEntity, MealLocalEntity> {

    override fun mapTo(entity: MealDataEntity): MealLocalEntity =
        MealLocalEntity(
            roomId = 0,
    ...
    override fun mapToList(
        entityList: List<MealDataEntity>
    ): List<MealLocalEntity> = entityList.map { mapTo(it) }
}